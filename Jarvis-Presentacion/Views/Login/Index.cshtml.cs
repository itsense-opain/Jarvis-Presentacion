...
namespace Opain.Jarvis.Presentacion.Web.Areas.Identity.Pages.Account
{
    ...
    public class LoginNModel : PageModel
    {
        ...
        private readonly ILogger<LoginNModel> logger;
        private readonly AppSettings appSettings;
        public InputModel Input { get; set; }
        public IConfiguration Configuration { get; }
        public bool Debug {get;}

        public LoginNModel( IServicioApi api, ILogger<LoginNModel> log, IConfiguration conf )
        {
            servicioApi = api;
            Debug = false;
            //signInManager = sim;
        ...
        private async Task<bool> ValidateReCaptcha()
        {
            try
            {
                ...
                //ToDo var captchaApi = new ReCaptchaService();
                //ToDo var isValid = await captchaApi.Verify2Async(captchaResponse, clientIp, appSettings.SecretKey);
